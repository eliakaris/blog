  ...
  <footer className="footer">
      <div className="container navbar">
        ...
        <div itemScope itemType="http://data-vocabulary.org/Person" className="hidden">
          ...
          <span itemProp="affiliation">Microsoft</span>
        </div>

        <p>© 2013 - 2017 <NavLink to="/about">Elia Karagiannis</NavLink> ∙ <a href="http://twitter.com/eliakaris">Follow @eliakaris</a> ∙ <a href="https://github.com/eliakaris/blog">View source</a></p>
      </div>
    </footer>);
}
